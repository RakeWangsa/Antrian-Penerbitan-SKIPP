                ...
                <tbody>
                  ...
                  @foreach($AntrianCS as $item)
                   <tr>
                      ...
                      <td>{{ $item->status }}</td>
                      <td>
                        <a class="btn btn-primary" style="border-radius: 100px;" a href="{{ route('statusDiprosesCS', ['id' => base64_encode($item->id)]) }}"><i class="bi bi-check-circle text-white"></i></a>
                        <a class="btn btn-warning" style="border-radius: 100px;" a href="{{ route('statusRecallCS', ['id' => base64_encode($item->id)]) }}"><i class="bi bi-telephone-forward text-white"></i></a>
                        <a class="btn btn-danger" style="border-radius: 100px;" a href="{{ route('statusCancelCS', ['id' => base64_encode($item->id)]) }}"><i class="bi bi-x-circle text-white"></i></a>
                      </td>
                   </tr>
                   @endforeach
                   @else
