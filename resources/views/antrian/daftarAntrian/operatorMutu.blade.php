                ...
                <tbody>
                  ...
                  @foreach($AntrianM as $item)
                   <tr>
                      ...
                      <td>{{ $item->status }}</td>
                      <td>
                        <a class="btn btn-primary" style="border-radius: 100px;" a href="{{ route('statusDiprosesM', ['no_ppk' => $item->no_ppk]) }}"><i class="bi bi-check-circle text-white"></i></a>
                        <a class="btn btn-warning" style="border-radius: 100px;" a href="{{ route('statusRecallM', ['no_ppk' => $item->no_ppk]) }}"><i class="bi bi-telephone-forward text-white"></i></a>
                        <a class="btn btn-danger" style="border-radius: 100px;" a href="{{ route('statusCancelM', ['no_ppk' => $item->no_ppk]) }}"><i class="bi bi-x-circle text-white"></i></a>
                      </td>
                   </tr>
                   @endforeach
                   @else
