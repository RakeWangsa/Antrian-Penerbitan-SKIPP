...
@section('container')
    ...
    <div class="card info-card ja-card pt-4 pb-4">
        <div class="card-body">
    <form method="GET" action="{{route('saveSetting')}}">
    <div class="row">
                    ...
                    <div class="d-flex align-items-center">
                       ...
                       <div class="ps-4 mt-4 mb-4">
                          ...
                          <div class="d-flex align-items-center mt-1">
                            <input type="number" class="form-control me-2" id="jedaK" name="jedaK" value="{{ $jedaK }}" required>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                       ...
                       <div class="ps-4 mt-4 mb-4">
                          ...
                          <span class="small pt-1 fw-bold">Jeda Antrian : </span>
                          <div class="d-flex align-items-center mt-1">
                            <input type="number" class="form-control me-2" id="jedaM" name="jedaM" value="{{ $jedaM }}" required>
                            <span class="small fw-bold">Menit</span>
                          </div>
                       </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                       ...
                       <div class="ps-4 mt-4 mb-4">
                          ...
                          <span class="small pt-1 fw-bold">Jeda Antrian : </span>
                          <div class="d-flex align-items-center mt-1">
                            <input type="number" class="form-control me-2" id="jedaCS" name="jedaCS" value="{{ $jedaCS }}" required>
                            <span class="small fw-bold">Menit</span>
                          </div>
                       </div>
                    </div>
