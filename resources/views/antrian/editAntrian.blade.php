            ...
            <div class="card col-md-12">
                <div class="card-body">
                    ...
                    <form class="row g-3 mt-3" method="GET" action="{{route('edit', ['no_ppk' => $no_ppk])}}">
                        ...
                        <div class="col-md-12"> <label for="noppk" class="form-label">Masukkan Nomor Pengajuan PPK Baru : </label> <input type="text" class="form-control" id="no_ppk" name="no_ppk" value="{{ old('no_ppk') }}"></div>
