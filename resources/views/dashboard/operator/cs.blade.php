                    ...
                    <tbody>
                        <tr style="text-align: center">
                            @if(isset($panggilCS))
                                <td>{{ $panggilCS }}</td>
                                <td>
                                    <button class="btn btn-success" style="border-radius: 100px;" onclick="playAudio('{{ $panggilCS }}')"><i class="bi bi-telephone"></i></button>
                                    <audio id="myAudio_{{ $panggilCS }}">
                                    <source src="{{ asset('audio/'.$panggilCS.'.mp3') }}" type="audio/mpeg">
                                    </audio>
                                    <script>
